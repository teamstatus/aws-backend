...
export const packBackendLambdas = async (): Promise<BackendLambdas> => ({
	...
	deleteSync: await packLambdaFromPath('deleteSync', 'lambdas/deleteSync.ts'),
	...
	onboarding: await packLambdaFromPath('onboarding', 'lambdas/onboarding.ts'),
})
